...
export function ProofImage({ src, caption, tall = false, forceFallback = false }: { src: string; caption: string; tall?: boolean; forceFallback?: boolean }) {
  const [missing, setMissing] = useState(forceFallback);
  return (
